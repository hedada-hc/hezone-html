...
pt.plogin = {
    ...
    getAuthUrl: function() {
        ...
        return /^https/.test(pt.ptui.s_url) && (t += "&pt4_shttps=1"),
    ...
    switchpage: function(t, e) {
        ...
        case 1:
            ...
            pt.plogin.isNewStyle || ($("switcher_plogin").className = "switch_btn_focus",
            $("switcher_qlogin").className = "switch_btn"),
            i = $("switcher_plogin").offsetWidth,
            $("switcher_plogin").parentNode.offsetWidth - i,
    ...
    generateEmailTips: function(t) {
        ...
        for (var n = [], o = 0, p = pt.plogin.knownEmail.length; o < p; o++)
            n.push(i + "@" + pt.plogin.knownEmail[o]);
        for (var r = [], s = 0, p = n.length; s < p; s++)
            n[s].indexOf(t) > -1 && r.push($.str.encodeHtml(n[s]));
    ...
    createEmailTips: function(t) {
        ...
        for (var p = 0; p < i; p++) {
            ...
            o = "emailTips_" + p,
            0 == p ? n.push("<li id=" + o + " class='hover' >" + e[p] + "</li>") : n.push("<li id=" + o + ">" + e[p] + "</li>")
        }
    ...
    init: function(t) {
        ...
        pt.plogin.isNewQr = !(25 != pt.ptui.style && 32 != pt.ptui.style && 33 != pt.ptui.style && !pt.plogin.isNewStyle && !pt.plogin.isTenpay),
        pt.ptui.isHttps = $.check.isHttps(),
        pt.plogin.setUrl(),
        pt.plogin.bindEvent(),
        ...
        "0" != pt.ptui.pt_3rd_aid && pt.qlogin.detectPCMgr(),
        pt.ptui.lockuin ? pt.plogin.doLockuin() : (pt.qlogin.fetchOnekeyList(),
        pt.qlogin.fetchQloginList()),
        !pt.plogin.isTim && pt.plogin.formFocus(),
    ...
    set_default_uin: function(t) {
        "0" != t && (t || (t = $.cookie.get("ptui_loginuin"),
        $.check.is_weibo_appid(pt.ptui.appid) || !$.check.isNick(t) && !$.check.isName(t) || (t = $.cookie.get("pt2gguin").replace(/^o/, "") - 0,
        t = 0 == t ? "" : t)),
        $("u").value = t,
        t && ($.css.hide($("uin_tips")),
    ...
    doLockuin: function() {
        ...
        $("u").readOnly = !0,
        $("qlogin_entry") && ($("qlogin_entry").style.display = "none");
        var t = $("uinArea");
    ...
    adjustErrTips: function() {
        if (pt.plogin.isNewStyle) {
            var t, e = $("error_tips"), i = $("loading_tips");
            ...
            $("qlogin_tips_4") && "block" == $.css.getComputedStyle($("qlogin_tips_4")).display && "block" == $.css.getComputedStyle($("qlogin")).display && (t = $("qlogin_tips_4")),
    ...
    show_err: function(t, e) {
        var i = $("onekey_step2");
        i && "block" == $.css.getComputedStyle(i).display ? $("onekey_tips").innerHTML = t : (pt.plogin.hideLoading(),
    ...
    hide_err: function() {
        var t = $("onekey_step2");
        t && "block" == $.css.getComputedStyle(t).display ? $("onekey_tips").innerHTML = "" : ($.css.hide($("error_tips")),
    ...
    showLoading: function(t) {
        pt.plogin.isNewStyle ? pt.plogin.adjustErrTips() : (t = pt.plogin.loginState == pt.LoginState.QLogin ? 10 : 20,
    ...
    u_refresh_dom: function() {
        "" == $("u").value ? ($.css.show($("uin_tips")),
        $("uin_tips").className = "input_tips_focus",
        $("uin_del") && $.css.hide($("uin_del"))) : ($.css.hide($("uin_tips")),
        $("uin_del") && $.css.show($("uin_del")))
    },
    u_change: function() {
        pt.plogin.set_account(),
    ...
    u_keyup: function(t) {
        "" == this.value ? ($.css.show($("uin_tips")),
        $("uin_tips").className = "input_tips_focus",
        $("uin_del") && $.css.hide($("uin_del"))) : $("uin_del") && $.css.show($("uin_del"));
        var e = t.keyCode;
        e != pt.plogin.keyCode.UP && e != pt.plogin.keyCode.DOWN && e != pt.plogin.keyCode.ENTER && e != pt.plogin.keyCode.TAB && e != pt.plogin.keyCode.F5 && ($("u").value.indexOf("@") > -1 ? (pt.plogin.showEmailTips(),
    ...
    email_click: function(t) {
        if ("li" == t.target.tagName.toLowerCase()) {
            ...
            e && ($("u").value = $.str.decodeHtml(e.innerHTML),
            pt.plogin.set_account(),
            pt.plogin.check()),
            pt.plogin.hideEmailTips(),
            t.stopPropagation()
    ...
    p_refresh_dom: function() {
        "" == $("p").value ? ($.css.show($("pwd_tips")),
        $("pwd_tips").className = "input_tips_focus") : $.css.hide($("pwd_tips"))
    },
    vc_focus: function() {
    ...
    check_cdn_img: function() {
        if (window.g_cdn_js_fail && !pt.ptui.isHttps) {
            ...
            t.onerror = function() {
                ...
                e = e.replace(new RegExp("http://imgcache.qq.com/ptlogin/v4/style/","g"), "http://ui.ptlogin2.qq.com/style/"),
    ...
    domLoad: function(t) {
        if (!pt.plogin.hasDomLoad) {
            ...
            var i = $("loading_img");
            if (i && i.setAttribute("src", i.getAttribute("place_src")),
            ...
            pt.plogin.isTenpay && ($.sso_ver >= 1093 ? $.report.monitor("451205") : $.report.monitor("451206")),
            ...
            pt.plogin.isNewStyle && setTimeout("window.scrollTo(0, 0)", 100),
            pt.plogin.isTim) {
                var n = $(bottom_qlogin);
                n && $.css.hide(n)
            }
            ...
            !pt.plogin.isTim && $.http.loadScript((pt.ptui.isHttps ? "https://ssl.captcha.qq.com/" : "http://captcha.qq.com/") + "template/TCapIframeApi.js?aid=" + pt.ptui.appid + "&rand=" + Math.random() + "&clientype=2&lang=" + pt.ptui.lang + "&apptype=2", function() {
                ...
                i.id = "newVcodeIframe",
                pt.plogin.isQcloud() ? (e.innerHTML = '<div style=" width: 300px; left:50%; margin-left:-150px; position: relative"><div style="position: relative; margin-left: 10px"><a href="javascript:pt.plogin.hideVC();" style="color: #007aff; text-decoration: none;">返回</a></div></div>',
                i.style.cssText = "background: none #FFFFFF; position: relative; width: 300px; left:50%; margin-left:-150px; z-index:9999;",
                t.appendChild(i),
                ...
                i.style.cssText = "background: none #FFFFFF; position: absolute; width: 300px; left:50%; margin-left:-150px; z-index:9999;",
                t.appendChild(e),
                t.appendChild(i)),
    ...
    bindEvent: function() {
        ...
        $("goBack"))
          ...
          , w = $("qr_info_link")
          , k = $("qrswitch_logo");
        k && $.e.add(k, "click", pt.plogin.switch_qrlogin),
        w && $.e.add(y, "click", function(t) {
            $.report.monitor("331287", .05)
        }),
        v && ($.e.add(v, "mouseover", pt.plogin.showQrTips),
        $.e.add(v, "mouseout", pt.plogin.hideQrTips)),
        m && $.e.add(m, "click", function(t) {
            t.preventDefault(),
            pt.plogin.go_qrlogin_step(1),
            $.report.monitor("331288", .05)
        }),
        _ && ($.e.add(_, "click", pt.plogin.authLogin),
        $.e.add(_, "mousedown", pt.plogin.authMouseDowm),
        $.e.add(_, "mouseup", pt.plogin.authMouseUp)),
        h && $.e.add(h, "click", pt.plogin.cancleAuth),
        f && $.e.add(f, "click", pt.plogin.ptui_notifyClose),
        c && $.e.add(c, "click", pt.plogin.onQloginSwitch),
        u && $.e.add(u, "click", function(t) {
            t.preventDefault(),
            pt.plogin.switchpage(pt.LoginState.PLogin),
            $.report.monitor("331285", .05)
        }),
        d && ($.e.add(d, "click", pt.plogin.bind_account),
        $.e.add(d, "mouseover", function(t) {
        ...
        var b = $("noscript_img");
        b && ($.e.add(b, "load", pt.plogin.noscript_err),
        $.e.add(b, "error", pt.plogin.noscript_err));
        var q = $("vip_link2");
    ...
    showNewVC: function() {
        ...
        $.css.show(t),
        pt.plogin.newVCFirst ? (pt.plogin.newVCFirst = !1,
        capInit($("newVcodeIframe"), {
    ...
    checkValidate: function(t) {
        try {
            ...
            if ($.check.isNullQQ(e.value))
                ...
                !1;
            var p = i.value;
            if (pt.plogin.armSafeEdit.isSafe && o && (p = o.GetPwdHash(),
            "D41D8CD98F00B204E9800998ECF8427E" == p && (p = ""),
            pt.plogin.armSafeEdit.safepwd = p),
            !p)
    ...
    hasCheck: function(t) {
        if (void 0 === t)
            return pt.plogin.checkState;
        pt.plogin.checkState = t
    },
    check: function(t) {
        if (0 === pt.plogin.checkState)
            return pt.plogin.check.cb = t;
    ...
    webLoginReport: function() {
        window.setTimeout(function() {
            try {
                ...
                if (i) {
                    for (var n = i[t[0]], o = 1, p = t.length; o < p; o++)
                        i[t[o]] && (e[o] = i[t[o]] - n);
    ...
    crossMessage: function(t) {
        if (pt.plogin.isUIStyle && pt.plogin.uistyleCM(t),
    ...
    ptui_notifySize: function(t) {
        ...
        pt.plogin.isNewStyle && (i.height -= $.css.getCurrentPixelStyle(e, "border-top-width") + $.css.getCurrentPixelStyle(e, "border-bottom-width"),
        e.style.height = i.height - $.css.getCurrentPixelStyle(e, "border-top-width") - $.css.getCurrentPixelStyle(e, "border-bottom-width") + "px"),
    ...
    go_qrlogin_step: function(t) {
        ...
        case 1:
            pt.plogin.begin_qrlogin(),
            pt.plogin.isNewQr ? $.css.hide($("qrlogin_step2")) : ($.css.show($("qrlogin_step1")),
    ...
    showQrTips: function() {
        if (!pt.plogin.isTim) {
            ...
            pt.qlogin.hasNoQlogin() || (i.left = i.left + $.css.getWidth("qrlogin_img") + 10,
    ...
    hideQrTips: function() {
        pt.plogin.isTim || pt.plogin.isNewQr && (window.clearTimeout(pt.plogin.hideQrTipsClock),
    ...
    resetQrTips: function() {
        pt.plogin.isTim || pt.plogin.isNewQr && ($("qrlogin_img") && ($("qrlogin_img").style.cssText = ""),
        $("qr_tips") && $.css.hide($("qr_tips")))
    },
    qr_load: function(t) {},
    qr_error: function(t) {},
    switch_qrlogin_animate: function() {
        var t = pt.plogin.isQrLogin
          , e = $("web_qr_login_show")
          , i = 0;
        t ? (pt.plogin.isNewStyle || (i = -$("web_login").offsetHeight,
        $("web_qr_login").style.height = ($("qrlogin").offsetHeight || 265) + "px"),
        $("qrlogin").style.visibility = "visible",
        $("web_login").style.visibility = "hidden") : (pt.plogin.isNewStyle || (i = 0,
    ...
    armSafeEdit: function() {
        function t() {
            if (pt.plogin.armSafeEdit.isSafe)
                ...
                e.removeChild(s),
                o.style.backgroundPosition = "-130px -130px",
                pt.plogin.armSafeEdit.isSafe = !1;
            else {
                var t = $("safe_edit");
                t ? s.style.display = "block" : (s.innerHTML = ($.suportActive() ? a : l) + c,
                e.appendChild(s),
                t = $("safe_edit"),
                ...
                try {
                    ...
                    o.style.backgroundPosition = "-117px -130px",
            ...
            return pt.plogin.armSafeEdit.isSafe ? e.style.height = "74px" : e.style.height = n,
            pt.plogin.ptui_notifySize("login"),
            !1
        }
        var e = $("pwdArea")
    ...
    onekeyVerify: function(t, e, i) {
        ...
        if (n) {
            ...
            for (var l = n.getElementsByTagName("span"), c = ["占位"], u = 0; u < l.length; u++)
                l[u].className.indexOf("ov-tips") > -1 && c.push(l[u]);
            p.onclick = function() {
            ...
            "hide" == t ? function() {
                ...
                setTimeout(function() {
                    s.value = "",
                    pt.plogin.domFocus(s)
                }, 0)
            }() : ("invalid" == t ? function() {
                pt.plogin.onekeyVerifyClock = 0,
                $.css.addClass(n, "invalid"),
                pt.plogin.hide_err(),
                $.e.add(r, "click", function() {
                    pt.plogin.onekeyVerify("hide")
                })
            }() : function() {
                $.css.setClass(n, "ov-" + e),
                c[e] && c[e].appendChild(o),
                i = i || pt.plogin.onekeyVerify.__tips || "你的帐号千金难求。为确保安全，请务必对手机收到的登录请求进行确认。",
